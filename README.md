...
<br />
<pre lang="markdown"> ```js const data = { pronouns: "She" | "Her", codename: "BrookLiNN", status: "operational", doing: "Automating minds & weaving neural networks through Django portals...", code: ["{Python}", "{Django}", "{FastAPI}", "{JavaScript}", "{Bash}"], askMeAbout: ["AI dev", "web dev", "model deployment", "clean code"], aiDev: { frameworks: ["TensorFlow", "PyTorch", "scikit-learn", "Transformers"], tools: ["Jupyter", "Pandas", "NumPy", "LangChain", "HuggingFace"], }, webdev: { backEnd: { technologies: ["Django", "FastAPI", "PostgreSQL", "Docker"], }, frontEnd: { technologies: ["HTML", "CSS", "JavaScript", "Alpine.js"], } }, contact: { github: "https://github.com/BrookLiNN", linkedin: "https://linkedin.com/in/BrookLiNN", email: "brooklinn@proton.me", portfolio: "https://brooklinn.dev", }, }; ``` </pre>
## 🔎 My characteristics
